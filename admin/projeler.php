					...
					if(!empty($_POST['proje_baslik']) || !empty($_POST['proje_aciklama'])) {
						...
						foreach ($_POST AS $k=>$v) {
							...
							if (substr($k,0,5) == "form_") {
								...
								$insert = $db->prepare("INSERT INTO ".TABLE." SET proje_baslik = ?, proje_seo = ?, proje_aciklama = ?, proje_isveren = ?, proje_yeri = ?,  proje_zamani = ?,  proje_alani = ?,  proje_yapilanis = ?, proje_resim = ?, dil_id = ?, kategori_id = ?, proje_durum = ?, proje_ust_id = ?");
								$insert->execute(array($proje_baslik[$key], Seo_Link_Cevir($proje_baslik[$key]), $proje_aciklama[$key], $proje_isveren[$key], $proje_yeri[$key], $proje_zamani[$key],  $proje_alani[$key],  $proje_yapilanis[$key],  $proje_resim, $key, $kategori_id, $proje_durum, $LastID));
													...
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Adı</label>
																<input type="text" name="proje_baslik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Adı" required="">
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje İşvereni</label>
																<input type="text" name="proje_isveren[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje İşvereni" required="">
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Yeri</label>
																<input type="text" name="proje_yeri[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Yeri" required="">
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Zamanı (Yıl)</label>
																<input type="text" name="proje_zamani[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Zamanı" required="">
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Alanı</label>
																<input type="text" name="proje_alani[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Alanı" required="">
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Yapılan İş</label>
																<input type="text" name="proje_yapilanis[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Yapılan İş" required="">
															</div>
														</div>
					...
					if(isset($submitControl)){
						if(!empty($_POST['proje_baslik']) || !empty($_POST['proje_aciklama'])) {
							...
							foreach ($_POST AS $k=>$v) {
								...
								if (substr($k,0,5) == "form_") {
									$key = str_replace("form_","",$k);
									$update = $db->prepare("UPDATE ".TABLE." SET  proje_baslik = ?, proje_seo = ?, proje_aciklama = ?,  proje_isveren = ?, proje_yeri = ?,  proje_zamani = ?,  proje_alani = ?,  proje_yapilanis = ?, proje_resim = ?, proje_durum = ?, kategori_id = ? WHERE proje_ust_id = ? AND dil_id = ?");
									$update->execute(array($proje_baslik[$key], Seo_Link_Cevir($proje_baslik[$key]), $proje_aciklama[$key],  $proje_isveren[$key], $proje_yeri[$key], $proje_zamani[$key],  $proje_alani[$key],  $proje_yapilanis[$key], $proje_resim, $proje_durum, $kategori_id, $id, $key));
								}
							}
							if ($update) {
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Adı</label>
																<input type="text" name="proje_baslik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Adı" required="" value="<?php echo GetTableValue("proje_baslik",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje İşvereni</label>
																<input type="text" name="proje_isveren[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje İşvereni" required="" value="<?php echo GetTableValue("proje_isveren",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Yeri</label>
																<input type="text" name="proje_yeri[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Yeri" required="" value="<?php echo GetTableValue("proje_yeri",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Zamanı (Yıl)</label>
																<input type="text" name="proje_zamani[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Zamanı (Yıl)" required="" value="<?php echo GetTableValue("proje_zamani",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Alanı</label>
																<input type="text" name="proje_alani[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Alanı" required="" value="<?php echo GetTableValue("proje_alani",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Yapılan İş</label>
																<input type="text" name="proje_yapilanis[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Yapılan İş" required="" value="<?php echo GetTableValue("proje_yapilanis",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
