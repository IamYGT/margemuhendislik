													...
													<div class="card">
														<div class="card-body">
															<div class="row">
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Ürün Çeşidi <span class="text-danger">*</span> </label>
																		<div class="col-lg-8">
																...
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Bölge Sayısı <span class="text-danger">*</span></label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">
