...
<head>
    ...
    <title>Bunso - Industry & Factory HTML5 Template</title>
                            ...
                            <div class="col-lg-3 col-md-3 col-2">
                                <div class="header-right">
                                    <div class="close-form">
                                        <a class="theme-btn" href="contact.html"><i
                                                class="fi flaticon-phone-call-1"></i><span>Contact Us</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col col-lg-6 col-12">
                            <p class="copyright"> Copyright &copy; 2022 Canun by <a href="index.html">wpOceans</a>. All
                                Rights Reserved.</p>
                        </div>
                        <div class="col col-lg-6 col-12">
